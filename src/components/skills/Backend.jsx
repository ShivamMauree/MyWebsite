        ...
        <div className="skills_info grid">
            ...
            <div className="skills_info_box">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <path
                        d="M16.41 21.32a29.75 29.75 0 0 1-9.14.14s.46.38 2.84.53c3.61.23 9.15-.12 9.29-1.83 0 0-.26.64-2.99 1.16z"></path>
                </svg>
                <h3 className="skills_title">Java</h3>
            ...
            <div className="skills_info_box">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: 'rgba(0, 0, 0, 1)', transform: '', msFilter: ''}}>
                    <g>
                        ...
                        <path d="M5 18v3c0 1.1 3.13 2 7 2s7-.9 7-2v-3" />


                        <ellipse cx="12" cy="13" rx="7" ry="2" />
                        <path d="M5 11v3c0 1.1 3.13 2 7 2s7-.9 7-2v-3" />

                        <ellipse cx="12" cy="6" rx="7" ry="2"/>
                        <path d="M5 4v3c0 1.1 3.13 2 7 2s7-.9 7-2V4"/>
                    </g>
                </svg>
                <h3 className="skills_title">SQL</h3>
                <span className="skills_subtitle">2+ years</span>
            </div>
            ...
            <div className="skills_info_box">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <path
                        d="M17 4.88a6.06 6.06 0 0 1 1.37 2.57.71.71 0 0 1 0 .15 5.67 5.67 0 0 1-.09 1.06 7.11 7.11 0 0 0-.09.86 6.61 6.61 0 0 0 .07 1 4 4 0 0 1-.36 2.71l.07.08c2.22-3.49 3-7.54 2.29-8.43a4.77 4.77 0 0 0-3.81-1.8 7.34 7.34 0 0 0-1.63.16A6.17 6.17 0 0 1 17 4.88z"></path>
                    <path
                ...
                <h3 className="skills_title">PostgreSQL</h3>
            ...
            <div className="skills_info_box">
                ...
                <h3 className="skills_title">Node.js</h3>
                <span className="skills_subtitle">2+ years</span>
            </div>
            ...
            <div className="skills_info_box">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     style={{fill: 'rgba(0, 0, 0, 1)', transform: '', msFilter: ''}}>
                    <path
                        d="M13.74 4.23c-.84-1-1.57-2-1.71-2.22H12c-.14.21-.87 1.22-1.71 2.22-7.2 9.19 1.14 15.39 1.14 15.39l.07.05c.06.95.22 2.33.22 2.33h.62s.15-1.37.21-2.33l.07-.06s8.32-6.19 1.12-15.38zM12 19.48a3.48 3.48 0 0 1-.48-.48L12 9l.45 10a3.57 3.57 0 0 1-.45.48z"></path>
                </svg>
                <h3 className="skills_title">MongoDb</h3>
