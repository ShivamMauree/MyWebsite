    ...
    return (
        <div className="skills_info grid">
            ...
            <div className="skills_info_box">
                ...
                <h3 className="skills_title">React</h3>
                <span className="skills_subtitle">2+ years</span>
            </div>
            ...
            <div className="skills_info_box">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     style={{fill: 'rgba(0, 0, 0, 1)', transform: '', msFilter: ''}}>
                    <path
                        d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12c2.1 0 4.075-.55 5.789-1.507L9.044 10.326v6.983H7.55V8.332h1.494l11.14 16.728C22.913 20.888 24 16.616 24 12 24 5.383 18.617 0 12 0zm4.15 15.875l-1.409-2.125V8.332h1.409v7.543z"/>
                </svg>
                <h3 className="skills_title">Next.js</h3>
