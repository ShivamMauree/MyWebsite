...
const Data =()=>{
    return(
        <div className="home_data">
            <h1 className="home_title">Shiv Mauree
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">I'm a web developer,data scientist and educator based in Youngstown. I
                create efficient web applications and insightful data visualizations.<br/><br/> Let's connect and turn
